...
public class AuxiliarService implements Serializable {
	...
	/**
	 * Este método recupera o endereço do usuario consumindo um webservice ultilizando o cep 
	 *
	 * @author Yuri Cavalcante {yuricavalcante914@hotmail.com}
	...
	/**
	 * 
	 * Este método tem a função de preparar o caminho, abrir a conexão com a URL e retornar um JSON. 
	 *
	...
	/**
	 * Este método calcula a distancia entre os usuarios e retorna o valor em um objeto DistanciaTO.
	 *
	 * @author Yuri Cavalcante {yuricavalcante914@hotmail.com}
